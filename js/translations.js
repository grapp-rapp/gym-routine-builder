...
const COPY = {
  en: {
    ...
    equipmentGuide: 'Equipment', prev: 'Previous day', next: 'Next day', routineFor: 'Routine for',
  ...
  he: {
    ...
    day: 'יום', exercise: 'תרגיל', sets: 'סטים', reps: 'חזרות / זמן', rest: 'מנוחה', equipment: 'ציוד', modified: 'מותאם',
    ...
    equipmentGuide: 'ציוד', prev: 'היום הקודם', next: 'היום הבא', routineFor: 'תוכנית עבור',
